...
if ( !class_exists( 'JITSO_Product' ) ) {
    ...
    final class JITSO_Product {
        ...
        */
        ...
        /**
         * Property that holds the single main instance of JITSO_Product.
         *
         * @since 1.1.0
         * @access private
         * @var JITSO_Product
        ...
        */
        ...
        /**
         * Ensure that there is only one instance of JITSO_Product is loaded or can be loaded (Singleton Pattern).
         *
         * @since 1.1.0
         * @access public
         *
         * @param array $dependencies Array of instances of dependencies for this class.
         * @return JITSO_Product
         */
        ...
        public function get_products( $args ) {
            ...
            if ( !is_array( $args ) )
                return new WP_Error( 'jitso-get_products-function-invalid-args' , __( 'Function "get_products" requires an $args argument in array format.' , 'just-in-time-sales-offers' ) , $args );

            $limit    = array_key_exists( 'limit' , $args ) ? $args[ 'limit' ] : null;
            $order_by = array_key_exists( 'order_by' , $args ) ? $args[ 'order_by' ] : 'DESC';

            $products = JITSO_Helper::get_all_products( $limit , $order_by );
            ...
            if ( array_key_exists( 'return_format' , $args  ) ) {
                ...
                switch ( $args[ 'return_format' ] ) {
                    ...
                    default:
                        return new WP_Error( 'jitso-get_products-function-unsupported-return_format' , __( 'Unsupported "return_format" in the $args argument.' , 'just-in-time-sales-offers' ) , $args );

                }

            } else
                return new WP_Error( 'jitso-get_products-function-missing-return_format-key-in-args' , __( 'Missing "return_format" key in the $args argument.' , 'just-in-time-sales-offers' ) , $args );
            ...
            switch ( $product->get_type() ) {
                ...
                case 'variable':
                    ...
                    $product_additional_data = array(
                        ...
                        'product_variations' => JITSO_Helper::get_product_variations( array( 'product' => $product ) )
                    );

                    break;

                default:
                    $product_additional_data = apply_filters( 'jitso_get_' . $product->get_type() . '_product_additional_info' , $product_additional_data , $product );
                    break;
