...
jQuery( document ).ready( function( $ ) {
    ...
    /*
     |--------------------------------------------------------------------------
     | Editor shortcodes legend
     |--------------------------------------------------------------------------
     */
    
    var $jitso_show_shortcodes_legend  = $( "#jitso-show-shortcodes-legend" ),
        $jitso_content_after_editor    = $( "#jitso-content-after-editor" ),
        $jitso_hide_shortcodes_legend  = $( "#jitso-hide-shortcodes-legend" );

    $jitso_show_shortcodes_legend.on( 'click' , function() {

        $jitso_show_shortcodes_legend.css( 'display' , 'none' );
        $jitso_content_after_editor.slideDown( 'fast' );

    } );

    $jitso_hide_shortcodes_legend.on( 'click' , function() {

        $jitso_content_after_editor.slideUp( 'fast' , function() {

            $jitso_show_shortcodes_legend.css( 'display' , 'inline-block' );
