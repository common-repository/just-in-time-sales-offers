...
jQuery( document ).ready( function( $ ) {
    ...
    var $accept_offer_actions_meta_box = $( "#accept-offer-actions-meta-box" ),
    ...
    $accept_offer_actions.on( 'add_new_accept_offer_action' , function( event , action_type ) {
        ...
        if ( action_type == 'add-products-to-cart' || action_type == 'apply-coupons-to-cart' ) {
            ...
            $.ajax( {
                url      : ajaxurl,
                type     : 'POST',
                data     : { action : 'jitso_get_new_accept_offer_action_markup' , offer_id : offer_id , args : args , 'ajax-nonce' : accept_sales_offer_actions_params.nonce_get_new_accept_offer_action_markup },
                dataType : 'json'
            } )
            ...
            .fail( function( jqxhr , text_status , error_thrown ) {
                ...
                console.log( jqxhr );
                vex.dialog.alert( accept_sales_offer_actions_params.i18n_failed_add_accept_offer_action );
    ...
    $add_action_btn.click( function() {
        ...
        if ( $accept_offer_action_types.val() ) {
            ...
            vex.dialog.alert( accept_sales_offer_actions_params.i18n_select_action_to_execute );
    ...
    $accept_offer_actions.on( "render_additional_product_data" , "#add-products-to-cart-action-container #add-products-to-cart-filter" , function( event , $parent_action_container , data , variation_id ) {
        ...
        if ( data.product_data.product_type == "variable" ) {
            ...
            var $product_filter_field_set = $parent_action_container.find( ".product-filter-field-set" ),
                variations_control_markup = '<select id="add-products-to-cart-filter-variations" style="min-width: 360px;" data-placeholder="' + accept_sales_offer_actions_params.i18n_select_variation + '">' +
                                            '<option value=""></option>';
            ...
            $product_filter_field_set.append(
                '<div class="additional-product-data">' +
                    '<label for="add-products-to-cart-filter-variations">' + accept_sales_offer_actions_params.i18n_product_variations + '</label> ' +
    ...
    $accept_offer_actions.on( "change" , "#add-products-to-cart-action-container #add-products-to-cart-filter" , function( event , variation_id ) {
        ...
        if ( $this.val() != "" ) {
            ...
            $.ajax( {
                url      : ajaxurl,
                type     : "POST",
                data     : { action : "jitso_get_product_additional_info" , product_id : $this.val() , 'ajax-nonce' : accept_sales_offer_actions_params.nonce_get_product_additional_info },
                dataType : "json"
            } )
            ...
            .fail( function( jqxhr , text_response , error_thrown ) {
                ...
                console.log( jqxhr );
                vex.dialog.alert( accept_sales_offer_actions_params.i18n_failed_retrieve_product_data );
    ...
    $accept_offer_actions.delegate( "#add-products-to-cart-action-container #add-products-to-cart-quantity" , "keydown" , function( e ) {
    ...
    $accept_offer_actions.on( "construct_data" , "#add-products-to-cart-action-container #add-product-to-cart-btn" , function( event , $action_container , data , errors ) {
        ...
        data[ 'product_type' ] = $meta.find( ".product-type" ).text();

        if ( $add_products_to_cart_filter.val() == "" )
            errors.push( accept_sales_offer_actions_params.i18n_select_product_to_add + "<br/>" );
        else
            data[ 'product_id' ] = $add_products_to_cart_filter.val();

        if ( $add_products_to_cart_quantity.val() == "" || $add_products_to_cart_quantity.val() <= 0 )
            errors.push( accept_sales_offer_actions_params.i18n_specify_product_quantity + "<br/>" );
        else
            data[ 'product_quantity' ] = $add_products_to_cart_quantity.val();
        ...
        if ( $product_filter_field_set.find( "#add-products-to-cart-filter-variations" ).length > 0 ) {
            ...
            if ( $product_filter_field_set.find( "#add-products-to-cart-filter-variations" ).val() == '' )
                errors.push( accept_sales_offer_actions_params.i18n_select_product_variation_to_add + "<br/>" );
            else
                data[ 'product_variation_id' ] = $product_filter_field_set.find( "#add-products-to-cart-filter-variations" ).val();
    ...
    $accept_offer_actions.on( "new_product_to_add" , "#add-products-to-cart-action-container #add-products-to-cart-table" , function( event , data ) {
        ...
        $.ajax( {
            url      : ajaxurl,
            type     : "POST",
            data     : { action : "jitso_generate_product_to_add_entry_markup" , offer_id : offer_id , data : data , 'ajax-nonce' : accept_sales_offer_actions_params.nonce_generate_product_to_add_entry_markup },
            dataType : "json"
        } )
        .done( function( data , text_status , jqxhr ) {
        ...
        .fail( function( jqxhr , text_status , error_thrown ) {
            ...
            console.log( jqxhr );
            vex.dialog.alert( accept_sales_offer_actions_params.i18n_failed_generate_product_entry_markup );
    ...
    $accept_offer_actions.delegate( "#add-products-to-cart-action-container #add-product-to-cart-btn" , "click" , function() {
        ...
        if ( errors.length > 0 ) {
            ...
            var err_msg = '<strong>' + accept_sales_offer_actions_params.i18n_fill_form_properly + '</strong><br>';
    ...
    $accept_offer_actions.delegate( "#add-products-to-cart-table .edit-product" , "click" , function() {
    ...
    $accept_offer_actions.delegate( "#add-products-to-cart-action-container #cancel-add-product-cart-edit-button" , "click" , function() {
    ...
    $accept_offer_actions.delegate( "#add-products-to-cart-action-container #add-product-to-cart-edit-button" , "click" , function() {
    ...
    $accept_offer_actions.delegate( "#add-products-to-cart-table .delete-product" , "click" , function() {
        ...
        vex.dialog.confirm( {
            message  : accept_sales_offer_actions_params.i18n_confirm_delete_product ,
                    ...
                    $tr.slideUp( "fast" , function() {
                        ...
                        if ( $accept_offer_actions.find( "#add-products-to-cart-table tbody tr" ).length <= 0 ) {
                            ...
                            $accept_offer_actions.find( "#add-products-to-cart-table tbody" ).append(
                                '<tr class="no-items">' +
                                    '<td class="colspanchange" colspan="' + accept_sales_offer_actions_params.add_product_table_total_columns + '">' + accept_sales_offer_actions_params.i18n_no_products_found + '</td>' +
                                '</tr>'
                            );
    ...
    $accept_offer_actions.on( "construct_data" , "#apply-coupons-to-cart-action-container #add-coupon-to-be-applied-to-cart-btn" , function( event , $action_container , data , errors ) {
        ...
        if ( $apply_coupon_to_cart_filter.val() == "" )
            errors.push( accept_sales_offer_actions_params.i18n_select_coupon_to_apply + "<br/>" );
        else {

            data[ 'coupon_id' ]        = $apply_coupon_to_cart_filter.val();
            data[ 'coupon_url' ]       = $apply_coupon_to_cart_filter.find( "option:selected" ).attr( "data-coupon-url" );
            data[ 'coupon_type' ]      = $apply_coupon_to_cart_filter.find( "option:selected" ).attr( "data-coupon-type" );
            data[ 'coupon_type_text' ] = $apply_coupon_to_cart_filter.find( "option:selected" ).attr( "data-coupon-type-text" );
            data[ 'coupon_amount' ]    = $apply_coupon_to_cart_filter.find( "option:selected" ).attr( "data-coupon-amount" );
    ...
    $accept_offer_actions.on( "new_coupon_to_apply" , "#apply-coupons-to-cart-action-container #apply-coupons-to-cart-table" , function( event , data ) {
        ...
        $.ajax( {
            url      : ajaxurl,
            type     : "POST",
            data     : { action : "jitso_generate_coupon_to_apply_entry_markup" , offer_id : offer_id , data : data , 'ajax-nonce' : accept_sales_offer_actions_params.nonce_generate_coupon_to_apply_entry_markup },
            dataType : "json"
        } )
        .done( function( data , text_status , jqxhr ) {
        ...
        .fail( function( jqxhr , text_status , error_thrown ) {
            ...
            console.log( jqxhr );
            vex.dialog.alert( accept_sales_offer_actions_params.i18n_failed_generate_coupon_entry_markup );
    ...
    $accept_offer_actions.delegate( "#apply-coupons-to-cart-action-container #add-coupon-to-be-applied-to-cart-btn" , "click" , function() {
    ...
    $accept_offer_actions.delegate( "#apply-coupons-to-cart-table .edit-coupon" , "click" , function() {
    ...
    $accept_offer_actions.delegate( "#apply-coupons-to-cart-action-container #cancel-edit-coupon-to-be-applied-to-cart-btn" , "click" , function() {
    ...
    $accept_offer_actions.delegate( "#apply-coupons-to-cart-action-container #edit-coupon-to-be-applied-to-cart-btn" , "click" , function() {
    ...
    $accept_offer_actions.delegate( "#apply-coupons-to-cart-table .delete-coupon" , "click" , function() {
        ...
        vex.dialog.confirm( {
            message  : accept_sales_offer_actions_params.i18n_confirm_delete_coupon ,
            callback : function( value ) {
                    ...
                    $tr.slideUp( "fast" , function() {
                        ...
                        if ( $accept_offer_actions.find( "#apply-coupons-to-cart-table tbody tr" ).length <= 0 ) {
                            ...
                            $accept_offer_actions.find( "#apply-coupons-to-cart-table tbody" ).append(
                                '<tr class="no-items">' +
                                    '<td class="colspanchange" colspan="' + accept_sales_offer_actions_params.apply_coupon_table_total_columns + '">' + accept_sales_offer_actions_params.i18n_no_coupons_added + '</td>' +
                                '</tr>'
                            );
    ...
    $accept_offer_actions.delegate( ".remove-action" , "click" , function() {

        var $this = $( this );

        vex.dialog.confirm( {
            message  : accept_sales_offer_actions_params.i18n_confirm_delete_action ,
            callback : function( value ) {
                ...
                if ( value ) {
                    ...
                    $action_container.slideUp( "fast" , function() {
                        ...
                        if ( $accept_offer_actions.find( ".accept-offer-action" ).length <= 0 )
                            $accept_offer_actions.append( accept_sales_offer_actions_params.i18n_no_action_to_take );
        ...
        if ( $this.attr( "data-action-type" ) == "add-products-to-cart" ) {
            ...
            $this.find( "#add-products-to-cart-table tbody tr" ).each( function() {
                ...
                if ( $row_meta.find( '.product-type' ).length > 0 ) {
                    ...
                    $save_accept_offer_actions_btn.trigger( 'construct_product_to_add_to_cart_additional_data' , [ d , $row_meta ] );
            ...
            $this.find( "#apply-coupons-to-cart-table tbody tr" ).each( function() {
                ...
                if ( $row_meta.find( '.coupon-id' ).length > 0 ) {
                    ...
                    $save_accept_offer_actions_btn.trigger( 'construct_coupon_to_apply_to_cart_additional_data' , [ d , $row_meta ] );                    
    ...
    $save_accept_offer_actions_btn.on( "click" , function( event , options_processing_stat ) {
        ...
        $.ajax( {
            url      : ajaxurl,
            type     : "POST",
            data     : { action : "jitso_save_accept_offer_actions" , offer_id : offer_id , data : data , 'ajax-nonce' : accept_sales_offer_actions_params.nonce_save_accept_offer_actions },
            dataType : "json"
        ...
        .done( function( data , text_status , jqxhr ) {
            ...
            if ( !options_processing_stat ) {
                ...
                if ( data.status == 'success' )
                    vex.dialog.alert( accept_sales_offer_actions_params.i18n_successfully_saved_action );
                else {
        ...
        .fail( function( jqxhr , text_status , error_thrown ) {
            ...
            if ( !options_processing_stat ) {
                ...
                console.log( jqxhr );
                vex.dialog.alert( accept_sales_offer_actions_params.i18n_failed_save_action );
