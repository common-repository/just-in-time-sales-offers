...
jQuery( document ).ready( function( $ ) {
    ...
    var $sales_offer_conditions_meta_box = $( "#sales-offer-conditions-meta-box" ),
        $meta                            = $sales_offer_conditions_meta_box.find( ".meta" ),
        offer_id                         = $.trim( $meta.find( ".offer-id" ).text() ),
        $offer_conditions                = $sales_offer_conditions_meta_box.find( "#offer-conditions" );
    ...
    $offer_conditions.on( "add_offer_condition_group" , ".offer-condition-group-controls .add-condition-group" , function( event , args , $this , $control_container ) {
        ...
        $.ajax( {
                url : ajaxurl,
                type : "POST",
                data : { action : "jitso_generate_offer_condition_group_markup" , offer_id : offer_id , args : args , 'ajax-nonce' : sales_offer_conditions_params.nonce_generate_offer_condition_group_markup },
                dataType : "json"
            } )
            ...
            .fail( function( jqxhr , text_status , error_thrown ) {
                ...
                console.log( jqxhr );
                vex.dialog.alert( sales_offer_conditions_params.i18n_failed_generate_condition_markup );
    ...
    $offer_conditions.delegate( ".offer-condition-group-controls .add-condition-group" , "click" , function() {
    ...
    $offer_conditions.delegate( ".offer-condition-group .offer-condition-group-actions .remove-condition-group" , "click" , function() {

        var condition_group = $( this ).closest( ".offer-condition-group" );

        vex.dialog.confirm( {
            message  : sales_offer_conditions_params.i18n_confirm_remove_condition_group ,
                        ...
                        if ( $offer_conditions.find( ".offer-condition-group").length == 1 ) {
                            ...
                            condition_group.replaceWith(
                                '<div id="no-offer-condition-container">' +
                                    '<p id="no-condition-message">' + sales_offer_conditions_params.i18n_no_condition_set + '</p>' +
                                '</div>'
                            );
    ...
    $offer_conditions.on( "construct_new_sales_offer_condition_markup" , ".offer-condition-controls .add-condition" , function( event , args , errors , $this , $controls_container ) {
        ...
        if ( $controls_container.find( ".condition-types" ).val() == "" )
            errors.push( "Please specify offer condition type" );
        else
    ...
    $offer_conditions.delegate( ".offer-condition-controls .show-add-condition-controls" , "click" , function() {
    ...
    $offer_conditions.delegate( ".offer-condition-controls .hide-add-condition-controls" , "click" , function() {
    ...
    $offer_conditions.delegate( ".offer-condition-controls .add-condition" , "click" , function() {
        ...
        $this.trigger( "construct_new_sales_offer_condition_markup" , [ args , errors , $this , $controls_container ] );

        if ( errors.length > 0 ) {

            var err_msg = '<strong>' + sales_offer_conditions_params.i18n_please_fill_form_properly + '</strong><br/>';
            ...
            $.ajax( {
                url : ajaxurl,
                type : "POST",
                data : { action : "jitso_generate_offer_condition_markup" , offer_id : offer_id , args : args , 'ajax-nonce' : sales_offer_conditions_params.nonce_generate_offer_condition_markup },
                dataType : "json"
            } )
            .done( function( data , text_status , jqxhr ) {
            ...
            .fail( function( jqxhr , text_status , error_thrown ) {
                ...
                console.log( jqxhr );
                vex.dialog.alert( sales_offer_conditions_params.i18n_failed_generate_offer_condition_markup );
    ...
    $offer_conditions.delegate( ".offer-condition .remove-condition" , "click" , function() {

        var $offer_condition = $( this ).closest( ".offer-condition"),
            $condition_group = $offer_condition.closest( ".offer-condition-group" );

        vex.dialog.confirm( {
            message  : sales_offer_conditions_params.i18n_confirm_remove_condition ,
            callback : function( value ) {
                        ...
                        if ( $condition_group.find( ".offer-condition" ).length == 1 ) {
                            ...
                            $offer_condition.replaceWith(
                                '<div class="empty-condition-group-container">' +
                                    '<p class="empty-condition-group-message">' + sales_offer_conditions_params.i18n_empty_condition_group + '</p>' +
                                '</div>'
                            );
    ...
    $offer_conditions.on( "reset_fields" , ".offer-condition .fields" , function( event ) {
        ...
        $this
            .find( ".product-in-cart option:first" ).attr( "selected" , "selected" ).trigger( "change" ).trigger( "chosen:updated" ).end()
            .find( ".product-in-cart-quantity-condition option:first" ).attr( "selected" , "selected" ).end()
            .find( ".product-in-cart-quantity" ).val( 1 );
    ...
    $offer_conditions.on( 'DOMNodeInserted' , function( e ) {
        ...
        if ( $new_element.attr( "class" ) == "offer-condition" && $new_element.attr( "data-condition-type" ) == "product-quantity" ) {
            ...
            $new_element.find( ".product-in-cart" ).chosen( { allow_single_deselect: true , search_contains:true } );
    ...
    $offer_conditions.on( "render_additional_product_data" , ".offer-condition" , function( event , data , variation_id ) {
        ...
        if ( data.product_data.product_type == "variable" ) {
            ...
            var $this                      = $( this ),
                $product_in_cart_field_set = $this.find( ".product-in-cart-field-set" ),
                any_selected               = ( variation_id && $.inArray( 'any' , variation_id ) != -1 ) ? 'selected="selected"' : '',
                variations_control_markup  = '<select class="product-in-cart-variations" multiple style="min-width: 340px;" data-placeholder="' + sales_offer_conditions_params.i18n_please_select_variation + '">' +
                                                '<option value="any" ' + any_selected + '>' + sales_offer_conditions_params.i18n_any_variation + '</option>';
            ...
            $product_in_cart_field_set.append(
                '<div class="additional-product-data">' +
                    '<label>' + sales_offer_conditions_params.i18n_product_variations + '</label> ' +
                    variations_control_markup +
                '</div>'
            );

            $product_in_cart_field_set.find( ".product-in-cart-variations" ).chosen( { search_contains: true } );
    ...
    $offer_conditions.on( "change" , ".offer-condition .product-in-cart-field-set .product-in-cart" , function( event , variation_id ) {

        event.stopPropagation();

        var $this                      = $( this ),
            $offer_condition           = $this.closest( ".offer-condition" ),
            $product_in_cart_field_set = $offer_condition.find( ".product-in-cart-field-set" ),
        ...
        if ( $this.val() != "" ) {
            ...
            $.ajax( {
                url      : ajaxurl,
                type     : "POST",
                data     : { action : "jitso_get_product_additional_info" , product_id : $this.val() , 'ajax-nonce' : sales_offer_conditions_params.nonce_get_product_additional_info },
                dataType : "json"
            } )
            ...
            .fail( function( jqxhr , text_response , error_thrown ) {
                ...
                console.log( jqxhr );
                vex.dialog.alert( sales_offer_conditions_params.i18n_failed_retrieve_product_data );
    ...
    $offer_conditions.on( "construct_product_quantity_in_cart_condition_entry_markup" , ".offer-condition .button-field-set .add-product-in-cart-btn" , function( event , data , errors , $this , $offer_condition ) {

        event.stopPropagation();

        data[ 'product-type' ] = $offer_condition.find( ".product-in-cart-field-set .meta .product-type" ).text();

        if ( $offer_condition.find( ".product-in-cart" ).val() == "" )
            errors.push( sales_offer_conditions_params.i18n_please_select_product );
        else
            data[ 'product-id' ] = $offer_condition.find( ".product-in-cart" ).val();

        if ( $offer_condition.find( ".product-in-cart-variations" ).length > 0 ) {

            if ( !$offer_condition.find( ".product-in-cart-variations" ).val() )
                errors.push( sales_offer_conditions_params.i18n_please_select_product_variation );
            else
                data[ 'product-variation-id' ] = $offer_condition.find( ".product-in-cart-variations" ).val();

        }

        if ( $offer_condition.find( ".product-in-cart-quantity-condition" ).val() == "" )
            errors.push( sales_offer_conditions_params.i18n_please_select_product_quantity_condition );
        else
            data[ 'product-quantity-condition' ] = $offer_condition.find( ".product-in-cart-quantity-condition" ).val();

        if ( $offer_condition.find( ".product-in-cart-quantity" ).val() == "" )
            errors.push( sales_offer_conditions_params.i18n_please_select_product_quantity );
        else
            data[ 'product-quantity' ] = $offer_condition.find( ".product-in-cart-quantity" ).val()

        return $this;

    } );

    $offer_conditions.on( "add_product_quantity_in_cart_condition_entry" , ".offer-condition .product-quantity-table" , function( event , data , $offer_condition , $product_quantity_table ) {
        ...
        $.ajax( {
            url      : ajaxurl,
            type     : "POST",
            data     : { action : "jitso_generate_product_quantity_in_cart_entry_markup" , offer_id : offer_id , data : data , 'ajax-nonce' : sales_offer_conditions_params.nonce_generate_product_quantity_in_cart_entry_markup },
            dataType : "json"
        } )
        .done( function( data , text_status , jqxhr ) {
        ...
        .fail( function( jqxhr , text_status , error_thrown ) {
            ...
            console.log( jqxhr );
            vex.dialog.alert( sales_offer_conditions_params.i18n_failed_generate_product_quantity_in_cart_entry_markup );
    ...
    $offer_conditions.delegate( ".offer-condition .button-field-set .add-product-in-cart-btn" , "click" , function() {
        ...
        $this.trigger( "construct_product_quantity_in_cart_condition_entry_markup" , [ data , errors , $this , $offer_condition ] );
        ...
        if ( errors.length > 0 ) {
            ...
            $product_quantity_table.trigger( "add_product_quantity_in_cart_condition_entry" , [ data , $offer_condition , $product_quantity_table ] );
    ...
    $offer_conditions.on( "prepopulate_product_quantity_in_cart_fields" , ".offer-condition .fields" , function( event , data ) {
        ...
        $this.find( ".product-in-cart-field-set .meta .product-type" ).text( data[ 'product-type' ] );
        $this.find( ".product-in-cart-field-set .product-in-cart" ).val( data[ 'product-id' ] ).trigger( "change" , [ variation_id ] ).trigger( "chosen:updated" );
        $this.find( ".product-in-cart-quantity-condition-field-set .product-in-cart-quantity-condition" ).val( data[ 'product-quantity-condition' ] );
        $this.find( ".product-in-cart-quantity-field-set .product-in-cart-quantity" ).val( data[ 'product-quantity' ] );
    ...
    $offer_conditions.delegate( ".offer-condition .product-quantity-table tbody tr .row-controls .edit-product" , "click" , function() {
    ...
    $offer_conditions.delegate( ".offer-condition .button-field-set .cancel-edit-product-in-cart-btn" , "click" , function() {
    ...
    $offer_conditions.delegate( ".offer-condition .button-field-set .edit-product-in-cart-btn" , "click" , function() {
        ...
        $offer_condition.find( ".add-product-in-cart-btn" ).trigger( "construct_product_quantity_in_cart_condition_entry_markup" , [ data , errors , $this , $offer_condition ] );
    ...
    $offer_conditions.delegate( ".offer-condition .product-quantity-table tbody tr .row-controls .delete-product" , "click" , function() {
        ...
        vex.dialog.confirm( {
            message  : sales_offer_conditions_params.i18n_confirm_remove_product,
            callback : function( value ) {
                    ...
                    $tr.slideUp( "fast" , function() {
                        ...
                        if ( $product_quantity_table.find( "tbody tr" ).length <= 0 ) {
                            ...
                            $product_quantity_table.find( "tbody" ).append(
                                '<tr class="no-items">' +
                                    '<td class="colspanchange" colspan="' + sales_offer_conditions_params.product_quantity_table_total_columns + '">' + sales_offer_conditions_params.i18n_no_products_added + '</td>' +
                                '</tr>'
                            );
    ...
    $( "#save-offer-conditions" ).on( "construct_sales_offer_conditions_data" , function( event , data ) {
    ...
    $( "#save-offer-conditions").on( "click" , function( event , options_processing_stat ) {
        ...
        $this.trigger( 'construct_sales_offer_conditions_data' , [ data ] );
        ...
        $.ajax( {
            url : ajaxurl,
            type : "POST",
            data : { action : "jitso_save_sales_offer_conditions" , offer_id : offer_id , data : data , 'ajax-nonce' : sales_offer_conditions_params.nonce_save_sales_offer_conditions },
            dataType : "json"
        } )
        .done( function( data , text_status , jqxhr ) {
            ...
            if ( !options_processing_stat ) {
                ...
                if ( data.status == 'success' )
                    vex.dialog.alert( sales_offer_conditions_params.i18n_success_save_conditions );
                else {
        ...
        .fail( function( jqxhr , text_status , error_thrown ) {
            ...
            if ( !options_processing_stat ) {
                ...
                console.log( jqxhr );
                vex.dialog.alert( sales_offer_conditions_params.i18n_failed_save_conditions );
    ...
    $offer_conditions.find( ".offer-condition-group .offer-condition .product-in-cart-field-set .product-in-cart" ).chosen( { allow_single_deselect: true , search_contains: true } );
