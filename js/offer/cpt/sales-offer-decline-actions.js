...
jQuery( document ).ready( function( $ ) {
    ...
    var $decline_offer_actions_meta_box = $( "#decline-offer-actions-meta-box" ),
    ...
    $save_decline_offer_actions_btn.on( "click" , function( event , options_processing_stat ) {
        ...
        if ( errors.length > 0 ) {
            ...
            var err_msg = '<strong>' + decline_sales_offer_actions_params.i18n_please_fill_form_properly + '</strong><br/>';
            ...
            $.ajax( {
                url : ajaxurl,
                type : 'POST',
                data : { action : "jitso_save_decline_offer_actions" , offer_id : offer_id , data : data , 'ajax-nonce' : decline_sales_offer_actions_params.nonce_save_decline_offer_actions },
                dataType : 'json'
            } )
            .done( function( data , text_status , jqxhr ) {
                ...
                if ( !options_processing_stat ) {
                    ...
                    if ( data.status == 'success' )
                        vex.dialog.alert( decline_sales_offer_actions_params.i18n_success_save_decline_offer_actions )
                    else {
            ...
            .fail( function( jqxhr , text_status , error_thrown ) {
                ...
                if ( !options_processing_stat ) {
                    ...
                    console.log( jqxhr );
                    vex.dialog.alert( decline_sales_offer_actions_params.i18n_failed_save_decline_offer_actions );
