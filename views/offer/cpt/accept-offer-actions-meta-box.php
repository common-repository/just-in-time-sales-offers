...
<div id="accept-offer-actions-meta-box" class="jitso-meta-box">

    <div class="meta" style="display: none !important;">
        <span class="offer-id"><?php echo $post->ID; ?></span>
    </div>

    <h3><?php _e( 'If offer is accepted do the following: ' , 'just-in-time-sales-offers' ); ?></h3>
    ...
    <div id="accept-offer-actions">
        ...
        <?php if (!empty( $accept_offer_actions ) ) {
            ...
            foreach ( $accept_offer_actions as $action_type => $action_data ) {
                    ...
                    <div id="add-products-to-cart-action-container" class="accept-offer-action" data-action-type="add-products-to-cart">
                        ...
                        <div class="fields">
                            ...
                            <div class="field-set product-filter-field-set">
                                ...
                                <select id="add-products-to-cart-filter" class="product-filter-control" style="min-width: 360px;" data-placeholder="<?php _e( 'Please select a product...' , 'just-in-time-sales-offers' ); ?>">
                        ...
                        <table id="add-products-to-cart-table" class="wp-list-table widefat fixed striped" cellspacing="0" width="100%">
                            ...
                            <tbody class="the-list">
                                ...
                                <?php if ( !empty( $action_data ) ) {
                                    ...
                                    foreach ( $action_data as $action ) { ?>
                                        <tr>
                                            ...
                                            <td class="row-meta hidden">
                                                ...
                                                <?php do_action( 'jitso_add-products-to-cart_additional_meta_markup' , $action ); ?>
                                            </td>
                                            ...
                                            <td class="product-text">
                                                ...
                                                if ( $action[ "product-type" ] == 'variable' ) {
                                                    ...
                                                    $product_text = apply_filters( 'jitso_' . $action[ "product-type" ] . '_product_to_add_entry_text' , $product_text , $action );
                                            ...
                                            <?php do_action( 'jitso_add-products-to-cart_additional_column_data_markup' , $action ); ?>
                                    ...
                                    <tr class="no-items">
                                        <td class="colspanchange" colspan="<?php echo $add_products_to_cart_table_total_columns; ?>"><?php _e( 'No products added' , 'just-in-time-sales-offers' ); ?></td>
                                    </tr>
                    ...
                    <div id="apply-coupons-to-cart-action-container" class="accept-offer-action" data-action-type="apply-coupons-to-cart">
                        ...
                        <div class="fields">
                            ...
                            <div class="field-set coupons-filter-field-set">
                                ...
                                <select id="apply-coupons-to-cart-filter" class="coupon-filter-control" style="min-width: 360px;" data-placeholder="<?php _e( 'Please select a coupon...' , 'just-in-time-sales-offers' ); ?>">
                        ...
                        <table id="apply-coupons-to-cart-table" class="wp-list-table widefat fixed striped" cellspacing="0" width="100%">
                            ...
                            <tbody class="the-list">
                                ...
                                <?php if ( !empty( $action_data ) ) {
                                    ...
                                    foreach ( $action_data as $action ) {
                                        $coupon_details = JITSO_Helper::get_coupon_info( $action[ 'coupon-id' ] );
                                        ...
                                        <tr>
                                            ...
                                            <td class="coupon">
                                                <?php $coupon_text = '<div class="coupon"><a href="' . $coupon_details[ 'coupon_url' ] . '" target="_blank">[ID : ' .  $action[ 'coupon-id' ] . '] ' . get_the_title( $action[ 'coupon-id' ] ) . '</a></div>';
                                                      $coupon_text = apply_filters( 'jitso_coupon_to_apply_entry_text' , $coupon_text , $action , $coupon_details );
                                                      echo $coupon_text; ?>
                                            </td>
                                            <td class="coupon-type-text"><?php echo $coupon_details[ 'coupon_type_text' ]; ?></td>
                                            <td class="coupon-amount"><?php echo $coupon_amount; ?></td>

                                            <?php do_action( 'jitso_apply-coupons-to-cart_additional_column_data_markup' , $action , $coupon_details ); ?>
                                    ...
                                    <tr class="no-items">
                                        <td class="colspanchange" colspan="<?php echo $apply_coupons_to_cart_table_total_columns; ?>"><?php _e( 'No coupons added' , 'just-in-time-sales-offers' ); ?></td>
                                    </tr>
                ...
                <?php } else {
                    ...
                    do_action( 'jitso_render_' . $action_type . '_accept_offer_action' , $action_data );
        ...
        <?php } else { ?>
            ...
            <p class="no-actions"><?php _e( 'No action to take. Click <b>"Add Action"</b> button to add one.' , 'just-in-time-sales-offers' ); ?></p>
    ...
    <div id="add-offer-action-controls">
        ...
        <?php do_action( 'jitso_add_accept_offer_action_additional_controls' ); ?>

        <input type="button" id="add-accept-offer-action-btn" class="button button-primary" value="<?php _e( 'Add Action' , 'just-in-time-sales-offers' ); ?>">
        <input type="button" id="save-accept-offer-actions-btn" class="button button-primary" value="<?php _e( 'Save Actions' , 'just-in-time-sales-offers' ); ?>">

        <select id="accept-offer-action-types">
            <option value=""><?php _e( '--Select Action--' , 'just-in-time-sales-offers' ); ?></option>
            ...
            <?php if ( !array_key_exists( 'remove-products-from-cart' , $accept_offer_action_types ) && !array_key_exists( 'remove-coupons-from-cart' , $accept_offer_action_types ) ) { ?>
                ...
                <option disabled="disabled" value="remove-products-from-cart"><?php _e( 'Remove Products From Cart (PREMIUM)' , 'just-in-time-sales-offers' ); ?></option>
                <option disabled="disabled" value="remove-coupons-from-cart"><?php _e( 'Remove Coupons From Cart (PREMIUM)' , 'just-in-time-sales-offers' ); ?></option>

            <?php } ?>
        </select>

        <input type="button" id="add-action-btn" class="button button-primary" value="<?php _e( 'Add' , 'just-in-time-sales-offers' ); ?>">
        <input type="button" id="cancel-add-action-btn" class="button button-secondary" value="<?php _e( 'Cancel' , 'just-in-time-sales-offers' ); ?>">
        <span class="spinner"></span>

    </div><!--#add-offer-action-controls-->

</div><!--#accept-offer-actions-meta-box-->
